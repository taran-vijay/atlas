...
For requests that take longer than a moment, Atlas says “One moment, sir”
using your selected voice. These are fixed local cues—not generated by the
AI—and no audio is sent away. Atlas also repairs a small set of unambiguous
speech-recognition slips before responding.
