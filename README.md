...
When recording begins, Atlas plays a short local listening chime. When speech
is released, it says “One moment, sir” while the local model works. These are
fixed macOS cues—not generated by the AI—and no audio is sent away. Atlas also
repairs a small set of unambiguous speech-recognition slips before responding.
